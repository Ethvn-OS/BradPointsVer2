...
const RestaurantOrderingUI = ({ onGoBack }) => {
  ...
  const menuItems = [
    { id: 1, name: 'Bacon Rolls', category: 'Rolls', points: 2, image: '/src/assets/baconRoll.jpg' },
    { id: 2, name: 'Batchoy', category: 'Rice Meals & Soups', points: 5, image: '/src/assets/batchoy.jpg' },
    { id: 3, name: 'Beef Rice', category: 'Rice Meals & Soups', points: 5, image: '/src/assets/beefRice.jpg' },
    { id: 4, name: 'Chicken Feet', category: 'Side Dishes', points: 3, image: '/src/assets/chickenFeet.jpg' },
    { id: 5, name: 'Chicken Rice', category: 'Side Dishes', points: 3, image: '/src/assets/chickenRice.jpg' },
    { id: 6, name: 'Crab Pincer', category: 'Side Dishes', points: 3, image: '/src/assets/crabPincer.jpg' },
    { id: 7, name: 'Empress Roll', category: 'Rolls', points: 2, image: '/src/assets/empressRoll.jpg' },
    { id: 8, name: 'Fried Wonton', category: 'Side Dishes', points: 3, image: '/src/assets/friedWanton.jpg' },
    { id: 9, name: 'Ngohiong', category: 'Side Dishes', points: 3, image: '/src/assets/ngohiong.jpg' },
    { id: 10, name: 'Pizza Roll', category: 'Rolls', points: 2, image: '/src/assets/pizzaRoll.jpg' },
    { id: 11, name: 'Shrimp Balls', category: 'Side Dishes', points: 3, image: '/src/assets/shrimpBalls.jpg' },
    { id: 12, name: 'Siomai', category: 'Side Dishes', points: 3, image: '/src/assets/siomai.jpg' },
    { id: 13, name: 'Siopao', category: 'Side Dishes', points: 3, image: '/src/assets/siopao.jpg' },
    { id: 14, name: 'Spring Rolls', category: 'Rolls', points: 2, image: '/src/assets/springRolls.jpg' },
    { id: 15, name: 'Steamed Chicken', category: 'Side Dishes', points: 3, image: '/src/assets/steamedChicken.jpg' },
    { id: 16, name: 'Steamed Rice', category: 'Rice Meals & Soups', points: 5, image: '/src/assets/steamedRice.jpg' },
    { id: 17, name: 'Sweet and Sour Pork', category: 'Side Dishes', points: 3, image: '/src/assets/sweetAndSour.jpg' },
  ];
